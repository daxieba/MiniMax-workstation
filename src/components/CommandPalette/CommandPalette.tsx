...
export function buildCommands(a: CommandPaletteActions): CommandItem[] {
  ...
  const cmds: CommandItem[] = [
    ...
    go('/calendar', t.sidebar.calendar, t.cmd.sectionTools, [t.shortcuts.navCalendar]),
    go('/pomodoro', t.sidebar.pomodoro, t.cmd.sectionTools, [t.shortcuts.navPomodoro]),
    go('/stats', t.sidebar.stats, t.cmd.sectionTools, [t.shortcuts.navStats]),
    go('/bookmarks', t.sidebar.bookmarks, t.cmd.sectionTools, []),
    go('/settings', t.sidebar.settings, t.cmd.sectionNavigation, [t.shortcuts.navSettings]),
    // 动作
    {
      id: 'action:lang:zh-CN',
      label: t.settings.language.zhCN,
      group: t.cmd.sectionActions,
      keywords: ['language', '语言', 'chinese', 'simplified', 'zh-CN', '简体中文'],
      run: () => a.setLang('zh-CN'),
    },
    {
      id: 'action:lang:zh-TW',
      label: t.settings.language.zhTW,
      group: t.cmd.sectionActions,
      keywords: ['language', '語言', 'chinese', 'traditional', 'zh-TW', '繁體中文', '台灣'],
      run: () => a.setLang('zh-TW'),
    },
    {
      id: 'action:lang:en-US',
      label: t.settings.language.enUS,
      group: t.cmd.sectionActions,
      keywords: ['language', '语言', 'english', 'en-US'],
      run: () => a.setLang('en-US'),
    },
    {
